...
class GazeSmoother:
    ...
    def __init__(self, min_cutoff=2000.0, beta=0.0, saccade_px_per_s=2500.0):
        # Higher min_cutoff & beta = less smoothing = faster response.
        # min_cutoff this high makes alpha (see OneEuro._alpha) saturate to
        # ~1.0 at any realistic frame interval -- i.e. no smoothing, raw
        # passthrough, per explicit request: responsiveness over stability.
